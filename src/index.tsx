...
// Eligible Frame - Not needed since we handle eligibility in the main frame now
// app.frame('/eligible', (c) => {
//   return c.res({
//     image: 'https://i.imgur.com/5iRDaNM.jpeg',
//     intents: [
//       <Button.Link href="https://app.optimism.io/airdrops/5">Claim Airdrop</Button.Link>,
//       <Button.Reset>Reset</Button.Reset>,
//     ],
...
// Not Eligible Frame - Not needed since we handle eligibility in the main frame now
// app.frame('/not-eligible', (c) => {
//   return c.res({
//     image: 'https://i.imgur.com/vYnfJed.jpeg',
//     intents: [
//       <Button.Reset>Reset</Button.Reset>,
//     ],
//   });
